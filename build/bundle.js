...
const redux_1 = __webpack_require__(20);
const react_router_redux_1 = __webpack_require__(29);
const reducers_1 = __webpack_require__(78);
const redux_thunk_1 = __webpack_require__(80);
...
const createStoreWithMiddleware = redux_1.applyMiddleware(redux_thunk_1.default, logger)(redux_1.createStore);
reducers_1.default['routing'] = react_router_redux_1.routerReducer;
const data = redux_1.combineReducers(reducers_1.default);
exports.default = createStoreWithMiddleware(data);
...
exports.countDays = (from, to) => Math.round(to.getTime() - from.getTime()) / (1000 * 60 * 60 * 24);
exports.countDaysInRange = (dateRange) => exports.countDays(dateRange.from, dateRange.to);
exports.formatDateInDaterange = (dateRange, dateToFormat) => {
    const daysCount = exports.countDaysInRange(dateRange);
    let granularity = 0;
    if (daysCount > 365)
        granularity = 1;
    if (daysCount > (365 * 5))
        granularity = 2;
    if (dateToFormat === 'to' && dateRange.infiniteTo)
        return '';
...
const routes_1 = __webpack_require__(35);
document.addEventListener('DOMContentLoaded', () => {
    const container = document.getElementById('container');
    ReactDOM.render(routes_1.default, container);
});
...
const store_1 = __webpack_require__(28);
const app_1 = __webpack_require__(81);
const history_1 = __webpack_require__(86);
exports.default = (React.createElement(react_redux_1.Provider, { store: store_1.default },
    React.createElement(react_router_1.Router, { history: history_1.default },
        React.createElement(react_router_1.Route, { component: app_1.default, path: "/timelines/:slug" }))));
...
Object.defineProperty(exports, "__esModule", { value: true });
const events_1 = __webpack_require__(79);
exports.default = { events: events_1.default };
...
const timeline_1 = __webpack_require__(84);
class Events extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "events" },
            React.createElement(timeline_1.default, { root: root, events: events })));
    }
}
...
exports.getEvents = (slug) => (dispatch, getState) => fetch('/api/events', {
    body: JSON.stringify({
        event: slug,
    }),
    headers: {
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(0);
const dates_1 = __webpack_require__(32);
const events_1 = __webpack_require__(85);
    ...
    render() {
        ...
        return (React.createElement("div", { className: "timeline" },
            React.createElement("header", null,
                React.createElement("div", { className: "pre-title" }, "TIMELINE OF"),
                React.createElement("h2", null, root.title),
                React.createElement("div", { className: "from" }, dates_1.formatDateInDaterange(root.dateRange, 'from')),
                React.createElement("div", { className: "to" }, dates_1.formatDateInDaterange(root.dateRange, 'to'))),
            React.createElement(events_1.default, Object.assign({}, this.props))));
    }
}
...
const react_router_1 = __webpack_require__(4);
const dates_1 = __webpack_require__(32);
const PointInTime = ({ event, root, pixelsPerDay }) => React.createElement("li", { className: "point-in-time", style: {
        left: `${dates_1.countDays(root.dateRange.from, event.date != null ? event.date : event.dateUncertain.from) * pixelsPerDay}px`,
    } }, event.title);
const IntervalOfTime = ({ event, root, pixelsPerDay }) => {
    return (React.createElement("li", { className: "interval-of-time", style: {
            left: `${dates_1.countDays(root.dateRange.from, event.dateRange.from) * pixelsPerDay}px`,
            width: `${dates_1.countDaysInRange(event.dateRange) * pixelsPerDay}px`,
        } },
        React.createElement(react_router_1.Link, { to: `/timelines/${event.slug}` }, event.title)));
};
const pixelsPerDay = (root) => {
    const clientWidth = document.documentElement.clientWidth;
    const daysCount = dates_1.countDaysInRange(root.dateRange);
...
class Events extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("ul", { className: "events" }, events.map((event, index) => (event.date != null || event.dateUncertain != null) ?
            React.createElement(PointInTime, Object.assign({}, this.state, { event: event, key: index, root: root })) :
            React.createElement(IntervalOfTime, Object.assign({}, this.state, { event: event, key: index, root: root })))));
    }
}
...
const react_router_redux_1 = __webpack_require__(29);
const store_1 = __webpack_require__(28);
exports.default = react_router_redux_1.syncHistoryWithStore(react_router_1.browserHistory, store_1.default);
